<div class="bg-gray-100 py-6 px-4 space-y-6 sm:p-6">
    <div>
        ...
        <x-forms.info class="px-0">
            Submit your article to the Laravel.io portal. Every article that gets approved will be shared with our
            45.000 users and wil be tweeted out on our <a href="https://twitter.com/laravelio"
                class="text-lio-700 underline">Twitter account</a> which has over 45,000 followers. Feel free to submit
            as many articles as you like. You can even cross-reference an article on your blog with the original url.
        </x-forms.info>
    ...
    <div class="flex flex-col space-y-6">
        ...
        <div class="flex-grow space-y-6">
            ...
            <div class="flex-grow space-y-6">
                <div class="space-y-1">
                    ...
                    <select name="tags[]" id="create-article" multiple x-data="{}"
        ...
        <div class="flex items-center justify-end">
            ...
            <div class="flex justify-end items-center">
                {{-- <a href="{{ isset($article) ? Panel::make()->get($article)->url() : route('user.articles') }}"
                    class="text-lio-700 mr-4">
                    Cancel
                </a> --}}

                @if (isset($article) && $article->isSubmitted())
                    <button type="submit" name="submitted" value="1" class="button button-primary">
                        Save changes
                    </button>
                @else
                    <span class="relative z-0 inline-flex shadow-sm" x-data="{ showDropdown: false }"
                        @click.outside="showDropdown = false">
                        <button type="submit" name="submitted" value="0"
                        ...
                        <span class="-ml-px relative block">
                            ...
                            <div class="origin-top-right absolute right-0 mt-2 w-60 rounded-md shadow-lg"
